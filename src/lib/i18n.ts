...
const translations: Record<LanguageCode, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.platformAuth": "分平台登录态",
    "settings.platformAuthHint": "抖音、Bilibili、YouTube 分开保存登录来源，互不覆盖。",
    "settings.loginSource": "登录源",
    "settings.browserSource": "浏览器来源",
    "settings.currentStatus": "当前状态",
    "settings.cookieFile": "Cookie 文件",
    "settings.cookieFilePlaceholder": "选择或粘贴 Netscape 格式 cookies.txt 路径",
    "settings.pickCookieFile": "选择 Cookie 文件",
    "settings.pickingCookieFile": "选择中…",
    "settings.cookieGuideTitle": "Windows 首次使用指引",
    "settings.cookieGuideBody": "Chrome 在 Windows 上可能无法直接解密登录 Cookie。首次使用建议直接导入 Cookie 文件，或把浏览器里的 Cookie 值粘贴到下面保存。保存后下次会继续复用，无需重新登录。",
    "settings.cookieGuideStep1": "先在浏览器里登录抖音或 Bilibili。",
    "settings.cookieGuideStep2": "优先导入 cookies.txt；如果没有文件，也可以复制请求头里的完整 Cookie 值并粘贴到下方。",
    "settings.cookieGuideStep3": "点击保存设置，应用会自动生成并复用本地登录态文件。",
    "settings.cookieText": "Cookie 文本",
    "settings.cookieTextPlaceholder": "可直接粘贴 Netscape cookies.txt 内容，或浏览器请求头里的完整 Cookie 值",
    ...
    "settings.proxyHintYoutube": "仅 YouTube 使用代理；抖音与 Bilibili 保持直连。",
  ...
  en: {
    ...
    "settings.platformAuth": "Per-platform Auth",
    "settings.platformAuthHint": "Store Douyin, Bilibili, and YouTube login sources separately.",
    "settings.loginSource": "Login Source",
    "settings.browserSource": "Browser Source",
    "settings.currentStatus": "Current Status",
    "settings.cookieFile": "Cookie File",
    "settings.cookieFilePlaceholder": "Select or paste a Netscape cookies.txt path",
    "settings.pickCookieFile": "Choose Cookie File",
    "settings.pickingCookieFile": "Choosing…",
    "settings.cookieGuideTitle": "Windows First-use Guide",
    "settings.cookieGuideBody": "Chrome on Windows may fail to decrypt browser cookies directly. For first use, import a cookies.txt file or paste the browser Cookie value below. After saving, StreamVerse reuses the saved login state so you do not need to log in every time.",
    "settings.cookieGuideStep1": "Log in to Douyin or Bilibili in your browser first.",
    "settings.cookieGuideStep2": "Prefer importing cookies.txt; if you do not have one, paste the full Cookie header value below.",
    "settings.cookieGuideStep3": "Save settings and the app will generate and reuse a local cookie file automatically.",
    "settings.cookieText": "Cookie Text",
    "settings.cookieTextPlaceholder": "Paste Netscape cookies.txt content or the full Cookie header value here",
    ...
    "settings.proxyHintYoutube": "Only YouTube uses the proxy; Douyin and Bilibili stay direct.",
